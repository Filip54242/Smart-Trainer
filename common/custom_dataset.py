...
class CustomDataset(MocapDataset):
    def __init__(self, detections_path, remove_static_joints=True):
        ...
        self._skeleton._children = [[1, 4, 7], [2], [3], [], [5], [6], [], [8, 11, 14], [9], [10], [], [12], [13], [],
                                    [15], [16], []]
        self._skeleton._has_children = [True, True, True, False, True, True, False, True, True, True, False, True, True,
                                        False, True, True, False]
        self._skeleton._joints_left = [4, 5, 6, 11, 12, 13]
        self._skeleton._joints_right = [1, 2, 3, 14, 15, 16]
        self._skeleton._parents = [-1, 0, 1, 2, 0, 4, 5, 0, 7, 8, 9, 8, 11, 12, 8, 14, 15]
