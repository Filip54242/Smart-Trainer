...
from common.camera import world_to_camera, normalize_screen_coordinates, project_to_2d_linear, project_to_2d
from common.generators import UnchunkedGenerator, ChunkedGenerator
from common.loss import mpjpe, weighted_mpjpe
...
if semi_supervised:
    ...
    optimizer = optim.Adam(list(model_pos_train.parameters()) + list(model_traj_train.parameters()), lr=lr,
                           amsgrad=True)
